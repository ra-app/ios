...
struct AppNotifications {
    ...
    static func category(_ type: Category) -> UNNotificationCategory {
        switch type {
        case .missedCall:
            return UNNotificationCategory(identifier: "com.ramicro.raapp.AppNotifications.Category.missedCall",
                                          actions: [ action(.callBack) ],
                                          intentIdentifiers: [],
                                          options: [])

        case .missedCallFromNoLongerVerifiedIdentity:
            return UNNotificationCategory(identifier: "com.ramicro.raapp.AppNotifications.Category.missedCallFromNoLongerVerifiedIdentity",
    ...
    static func action(_ type: Action) -> UNNotificationAction {
        switch type {
        case .callBack:
            return UNNotificationAction(identifier: "com.ramicro.raapp.AppNotifications.Action.callBack",
                                        title: CallStrings.callBackButtonTitle,
                                        options: .authenticationRequired)
        case .showThread:
            return UNNotificationAction(identifier: "com.ramicro.raapp.AppNotifications.Action.showThread",
